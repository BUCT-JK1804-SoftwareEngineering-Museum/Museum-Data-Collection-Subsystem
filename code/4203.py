...
class FirstSpider(scrapy.Spider):
    ...
    def parse(self,response):
        ...
        for i in range(1,4):
            col_id+=100
            col_url='http://pano.bwgyou.com/api/queryGoods?jsonpCallback=jQuery32109377743780914711_1620545033291&page=%s'%i+'&rows=12&museumId=16&tagTemp=1&goodsClassId=24&_=1620545033295'
