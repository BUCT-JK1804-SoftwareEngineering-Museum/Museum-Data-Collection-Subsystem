...
class FirstSpider(scrapy.Spider):
    ...
    def parse_new(self,response):
        col_name=response.xpath('/html/body/div[3]/div[2]/div[2]/div[2]/div[1]/h1/text()').extract()[0]
        mus_name='北京天文馆'
    ...
    def parse_cols(self, response):
        url_list=response.xpath('/html/body/div[3]/div[2]/div[3]/div[2]/div/ul')
        for li in url_list:
            j=li.xpath('./li/a/@href').extract()
            for i in j:
                new_url='http://www.bjp.org.cn'+i
    ...
    def parse(self,response):
        # col_id = 111000001
        # url='http://www.bjp.org.cn/kxyj/zpzs/szl/list.shtml'
        # yield scrapy.Request(url,callback=self.parse_cols,meta={'col_id':col_id})
        # col_id+=100
        #
        # url = 'http://www.bjp.org.cn/kxyj/zpzs/zbyql/list.shtml'
        # yield scrapy.Request(url, callback=self.parse_cols, meta={'col_id': col_id})
        # col_id += 100
        #
        # url = 'http://www.bjp.org.cn/kxyj/zpzs/tql/list.shtml'
        # yield scrapy.Request(url, callback=self.parse_cols, meta={'col_id': col_id})
        # col_id += 100
        #
        # url = 'http://www.bjp.org.cn/kxyj/zpzs/zzl/list.shtml'
        # yield scrapy.Request(url, callback=self.parse_cols, meta={'col_id': col_id})
        # col_id += 100
        #
        # url = 'http://www.bjp.org.cn/kxyj/zpzs/ysl/list_2.shtml'
        # yield scrapy.Request(url, callback=self.parse_cols, meta={'col_id': col_id})
        # col_id += 100
        #
        # url = 'http://www.bjp.org.cn/kxyj/zpzs/wyjl/list.shtml'
        # yield scrapy.Request(url, callback=self.parse_cols, meta={'col_id': col_id})
        # col_id += 100
        #
        # url = 'http://www.bjp.org.cn/kxyj/zpzs/wyjl/list_2.shtml'
        # yield scrapy.Request(url, callback=self.parse_cols, meta={'col_id': col_id})
        # col_id += 100
        #
        # url = 'http://www.bjp.org.cn/kxyj/zpzs/ysl/list.shtml'
        # yield scrapy.Request(url, callback=self.parse_cols, meta={'col_id': col_id})
        # col_id += 100
