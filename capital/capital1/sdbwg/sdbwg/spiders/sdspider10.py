...
class Sdspider10Spider(scrapy.Spider):
    name = 'sdspider10'
    allowed_domains = ['http://www.capitalmuseum.org.cn/']
    start_urls = ['http://www.capitalmuseum.org.cn/jpdc/ww.htm']
    ...
    def parse(self, response):
        ...
        #设置“下一页”
        next_url = self.base_url+"ww_"+str(self.x)+".htm"
        #测试网络跳转情况
        self.x += 1
        # print('#' * 40)
        # print(next_url)
    ...
    def parse_detail(self,response):
        ...
        introduction = response.xpath("//td[@class='wcontent']/table/tr[4]/td[2]/table/tr[2]/td//p[3]/text()").getall()
