...
class Sdspider8Spider(scrapy.Spider):
    name = 'sdspider8'
    allowed_domains = ['http://www.capitalmuseum.org.cn/']
    start_urls = ['http://www.capitalmuseum.org.cn/jpdc/hh.htm']
    ...
    def parse(self, response):
        ...
        #设置“下一页”
        next_url = self.base_url+"sf_"+str(self.x)+".htm"
        #测试网络跳转情况
        self.x += 1
        # print('#' * 40)
        # print(next_url)
    ...
    def parse_detail(self,response):
        ...
        introduction = response.xpath("//td[@class='wcontent']/table/tr[4]/td[2]/table/tr[2]/td/p[1]/text()").getall()
