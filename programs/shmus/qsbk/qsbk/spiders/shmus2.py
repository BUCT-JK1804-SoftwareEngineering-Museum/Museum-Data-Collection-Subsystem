...
class ShmusSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for i in range(1,5):#76
            ...
            page_url="https://www.shanghaimuseum.net/mu/frontend/pg/collection/search-antique"
            request=scrapy.FormRequest(page_url,formdata=data,callback=self.parse_page)
